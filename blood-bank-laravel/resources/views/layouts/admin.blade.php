...
<head>
    ...
    <title>@yield('title', 'Admin Dashboard') — BloodLink</title>
...
<div class="sidebar">
    ...
    <div class="sidebar-admin">{{ auth('admin')->user()->full_name ?? 'Admin' }}</div>
    <nav>
        <a href="{{ route('admin.dashboard') }}" class="{{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
            <i class="fas fa-home"></i> Dashboard
        </a>
        <a href="{{ route('admin.donors.index') }}" class="{{ request()->routeIs('admin.donors.*') ? 'active' : '' }}">
            <i class="fas fa-users"></i> Manage Donors
        </a>
        <a href="{{ route('admin.donors.locations') }}" class="{{ request()->routeIs('admin.donors.locations') ? 'active' : '' }}">
            <i class="fas fa-map-location-dot"></i> Donor Locations
        </a>
        <a href="{{ route('admin.blood-stock.index') }}" class="{{ request()->routeIs('admin.blood-stock.*') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.ai-chat') }}" class="{{ request()->routeIs('admin.ai-chat') ? 'active' : '' }}">

...
<script>
    ...
    function formatRequestCreated(data) {
        ...
        html += `<a href="<?php echo e(route('user.requests.index')); ?>" class="btn btn-primary btn-sm"><i class="fas fa-list"></i> View My Requests</a>`;
        html += `</div>`;
        return html;
    }
    ...
    function formatNoStock(data) {
        ...
        html += `</ul>`;
        html += `<div class="action-buttons">`;
        html += `<a href="<?php echo e(route('user.donors')); ?>" class="btn btn-outline-primary btn-sm"><i class="fas fa-users"></i> Find Compatible Donors</a>`;
        html += `</div>`;
        return html;
    }
    ...
    function formatAuthRequired(data) {
        ...
        html += `<div class="action-buttons">`;
        html += `<a href="<?php echo e(route('user.login')); ?>" class="btn btn-primary btn-sm"><i class="fas fa-sign-in-alt"></i> Login</a>`;
        html += `<a href="<?php echo e(route('user.register')); ?>" class="btn btn-outline-primary btn-sm"><i class="fas fa-user-plus"></i> Register</a>`;
        html += `</div>`;
        return html;
    }
    ...
    function formatDonorInfo(data) {
        ...
        html += `<div class="action-buttons">`;
        html += `<a href="<?php echo e(route('user.donors')); ?>" class="btn btn-primary btn-sm"><i class="fas fa-users"></i> View All Donors</a>`;
        html += `<a href="<?php echo e(route('user.find-nearby')); ?>" class="btn btn-outline-primary btn-sm"><i class="fas fa-map-marker-alt"></i> Find Nearby</a>`;
        html += `</div>`;
        return html;
    }
    ...
    function requestPartial(bloodGroup, units, hospital, urgency) {
        ...
        fetch('<?php echo e(route("ai.partial-request")); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Python\Web_dev\blood-bank-laravel\resources\views/user/ai-chat.blade.php ENDPATH**/ ?>
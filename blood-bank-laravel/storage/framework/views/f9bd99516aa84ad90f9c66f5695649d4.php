...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Blood Bank Management System'); ?></title>
...
<body>
        ...
        <div class="nav-inner">
            ...
            <div class="nav-links">
                <?php if(auth()->guard('admin')->check()): ?>
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-btn nav-btn-solid">
                        <i class="fas fa-tachometer-alt"></i> Dashboard
                    </a>
                    <a href="<?php echo e(route('admin.logout')); ?>" class="nav-btn nav-btn-ghost" onclick="event.preventDefault(); document.getElementById('admin-logout-form').submit();">
                ...
                @elseifauth('user')
                    <a href="<?php echo e(route('user.dashboard')); ?>" class="nav-btn nav-btn-solid">
                        <i class="fas fa-tachometer-alt"></i> Dashboard
                    </a>
                    <a href="<?php echo e(route('user.logout')); ?>" class="nav-btn nav-btn-ghost" onclick="event.preventDefault(); document.getElementById('user-logout-form').submit();">
                        <i class="fas fa-sign-out-alt"></i> Logout
                    </a>
                    <form id="user-logout-form" action="<?php echo e(route('user.logout')); ?>" method="POST" style="display: none;">
                        <?php echo csrf_field(); ?>
                    </form>
                <?php else: ?>
                    <a href="<?php echo e(route('admin.login')); ?>" class="nav-btn nav-btn-ghost">Admin</a>
                    <a href="<?php echo e(route('user.login')); ?>" class="nav-btn nav-btn-solid">Sign In</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
    ...
    <footer class="page-footer">
        ...
        <div class="footer-sub">© <?php echo e(date('Y')); ?> Blood Bank Management System. Built to save lives.</div>
    </footer>
    <?php endif; ?>
...
<?php /**PATH E:\Python\Web_dev\blood-bank-laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>
            ...
            <div class="col-md-8">
                <div class="register-card">
                    ...
                    <div class="p-4">
                        ...
                        <form method="POST" action="<?php echo e(route('user.register')); ?>" enctype="multipart/form-data" onsubmit="return validateForm()">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="tel" class="form-control" name="phone" value="<?php echo e(old('phone')); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="address" rows="2"><?php echo e(old('address')); ?></textarea>
                            </div>

                            <!-- Donor checkbox -->
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="register_as_donor" name="register_as_donor" onchange="toggleDonorFields()" <?php echo e(old('register_as_donor') ? 'checked' : ''); ?>>
                            ...
                            <!-- Donor fields -->
                            <div id="donor_fields" style="display: <?php echo e(old('register_as_donor') ? 'block' : 'none'); ?>;">
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number" class="form-control" name="age" min="18" max="65" value="<?php echo e(old('age')); ?>" placeholder="18–65">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select" name="gender">
                                                    ...
                                                    <?php $__currentLoopData = ['Male', 'Female', 'Other']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gender): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($gender); ?>" <?php echo e(old('gender') === $gender ? 'selected' : ''); ?>><?php echo e($gender); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" name="last_donation_date" value="<?php echo e(old('last_donation_date')); ?>">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select" name="is_smoker">
                                                    <option value="no" <?php echo e(old('is_smoker') === 'no' ? 'selected' : ''); ?>>No</option>
                                                    <option value="yes" <?php echo e(old('is_smoker') === 'yes' ? 'selected' : ''); ?>>Yes</option>
                                                </select>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">Do you have hepatitis?</label>
                                                <select class="form-select" name="has_hepatitis">
                                                    <option value="no" <?php echo e(old('has_hepatitis') === 'no' ? 'selected' : ''); ?>>No</option>
                                                    <option value="yes" <?php echo e(old('has_hepatitis') === 'yes' ? 'selected' : ''); ?>>Yes</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Other Medical Conditions</label>
                                            <textarea class="form-control" name="medical_conditions" rows="2"><?php echo e(old('medical_conditions')); ?></textarea>
                                        </div>
                                        <div class="mb-3">
                        ...
                        <div class="text-center">
                            <p>Already have an account? <a href="<?php echo e(route('user.login')); ?>">Login here</a></p>
...
<?php /**PATH E:\Python\Web_dev\blood-bank-laravel\resources\views/user/register.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'BloodLink — Save Lives, Donate Blood'); ?>
    ...
    <div class="hero-inner">
        <div class="hero-left fade-up">
            ...
            <div class="hero-cta-row">
                <a href="<?php echo e(route('user.register')); ?>" class="cta-primary"><i class="fas fa-tint"></i> Become a Donor</a>
                <a href="<?php echo e(route('user.login')); ?>" class="cta-secondary"><i class="fas fa-search"></i> Request Blood</a>
            </div>
            <div class="hero-stats">
                <div class="stat-item">
                    <div class="stat-num"><?php echo e($totalUnits); ?></div>
                    <div class="stat-label">Units Available</div>
                </div>
                <div class="stat-item">
                    <div class="stat-num"><?php echo e($bloodStock->count()); ?></div>
            ...
            <div class="hero-card">
                ...
                <div class="blood-type-grid">
                    <?php $__currentLoopData = $bloodStock; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <div class="blood-chip <?php echo e($cls); ?>">
                            <div class="blood-chip-type"><?php echo e($stock->blood_group); ?></div>
                            <div class="blood-chip-units"><?php echo e($qty); ?> <?php echo e($unit); ?></div>
                        </div>
                ...
                <div class="stock-bar-wrap">
                    <div class="stock-label-row">
                        ...
                        <span><?php echo e($totalUnits); ?> / <?php echo e($maxUnits); ?> units</span>
                    </div>
                    <div class="stock-bar-track">
                        <div class="stock-bar-fill" style="width:<?php echo e($stockPercentage); ?>%"></div>
                    </div>
                </div>
                <div class="hero-card-footer">
                    <div class="live-badge"><div class="live-dot"></div> Live data</div>
                    <a href="<?php echo e(route('user.login')); ?>" class="card-action-link">View all <i class="fas fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </div>
...
<section class="features-section">
    <div class="section-inner">
        ...
        <div class="features-grid">
            <a href="<?php echo e(route('user.register')); ?>" class="feat-card fade-up" style="transition-delay:.05s">
            ...
            <a href="<?php echo e(route('user.login')); ?>" class="feat-card fade-up" style="transition-delay:.1s">
            ...
            <a href="<?php echo e(route('user.login')); ?>" class="feat-card fade-up" style="transition-delay:.15s">
...
<section class="urgency-section">
    <div class="urgency-inner fade-up">
        <div class="urgency-text">
            ...
            <h2 class="urgency-title"><?php echo e($criticalGroup); ?> blood critically<br>low — donate today</h2>
        ...
        <a href="<?php echo e(route('user.register')); ?>" class="urgency-cta"><i class="fas fa-heart"></i> Register Now</a>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Python\Web_dev\blood-bank-laravel\resources\views/home.blade.php ENDPATH**/ ?>
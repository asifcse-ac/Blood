<?php $__env->startSection('title', 'Find Nearby Donors'); ?>
...
<script>
    document.getElementById('searchBtn').addEventListener('click', function() {
        ...
        navigator.geolocation.getCurrentPosition(function(position) {
            ...
            fetch('<?php echo e(route('user.get-nearby-donors')); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Python\Web_dev\blood-bank-laravel\resources\views/user/find-nearby.blade.php ENDPATH**/ ?>
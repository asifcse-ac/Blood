<?php $__env->startSection('title', 'Track Blood Stock'); ?>
...
<div class="hero-section text-center">
    ...
    <h3>Total Available: <span class="badge bg-danger"><?php echo e($totalUnits); ?> Units</span></h3>
</div>
    ...
    <?php $__currentLoopData = $bloodStock; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-md-3">
            <div class="blood-card">
                ...
                <hr>
                <h4 class="text-<?php echo e($statusClass); ?>"><?php echo e($qty); ?> Units</h4>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Python\Web_dev\blood-bank-laravel\resources\views/user/track-stock.blade.php ENDPATH**/ ?>